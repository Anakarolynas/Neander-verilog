module FSM( // Sequenciador: controla em qual passo do ciclo busca/decodificação/execução estamos
    ...
    output reg [3:0] state // estado atual (ajuste a largura conforme o número de estados que você definir)
    );
    parameter FETCH_STEP_1 = 4'b0000; // Estado de busca 1
    parameter FETC_STEP_2 = 4'b0001; // Estado de busca 2
    parameter DECODE = 4'b0010; // Estado de decodificação
    parameter EXECUTE = 4'b0011; // Estado de execução 1
    parameter FETCH_OPERAND_STEP_1 = 4'b0100; // Estado de busca do operando, primeiro passo
    parameter FETCH_OPERAND_STEP_2 = 4'b0101; // Estado de busca do operando, segundo passo
