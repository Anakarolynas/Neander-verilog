#!/usr/bin/env bash
# ============================================================
#  NEANDER - Simulacao do testbench da CPU
#
#  Uso:
#    ./tb/cpu/cpu_tb.sh        (de qualquer pasta do projeto)
#
#  Versao Linux/macOS do cpu_tb.bat. Compila tb/cpu/cpu_tb.v
#  junto com os fontes do modulo e roda a simulacao.
#
#  Gera:
#    sim/sim_cpu     executavel da simulacao
#    sim/cpu.vcd     formas de onda, para abrir no GTKWave
# ============================================================
