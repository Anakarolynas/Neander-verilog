#!/usr/bin/env bash
# ============================================================
#  NEANDER - Simulacao do testbench do multiplexador
#
#  Uso:
#    ./tb/mux/mux_tb.sh        (de qualquer pasta do projeto)
#
#  Versao Linux/macOS do mux_tb.bat. Compila tb/mux/mux_tb.v
#  junto com os fontes do modulo e roda a simulacao.
#
#  Gera:
#    sim/sim_mux     executavel da simulacao
#    sim/mux.vcd     formas de onda, para abrir no GTKWave
# ============================================================
