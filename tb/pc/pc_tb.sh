#!/usr/bin/env bash
# ============================================================
#  NEANDER - Simulacao do testbench do contador de programa
#
#  Uso:
#    ./tb/pc/pc_tb.sh        (de qualquer pasta do projeto)
#
#  Versao Linux/macOS do pc_tb.bat. Compila tb/pc/pc_tb.v
#  junto com os fontes do modulo e roda a simulacao.
#
#  Gera:
#    sim/sim_pc     executavel da simulacao
#    sim/pc.vcd     formas de onda, para abrir no GTKWave
# ============================================================
