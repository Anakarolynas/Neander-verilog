#!/usr/bin/env bash
# ============================================================
#  NEANDER - Simulacao do testbench da ULA
#
#  Uso:
#    ./tb/ula/ula_tb.sh        (de qualquer pasta do projeto)
#
#  Versao Linux/macOS do ula_tb.bat. Compila tb/ula/ula_tb.v
#  junto com os fontes do modulo e roda a simulacao.
#
#  Gera:
#    sim/sim_ula     executavel da simulacao
#    sim/ula.vcd     formas de onda, para abrir no GTKWave
# ============================================================
