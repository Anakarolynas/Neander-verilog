@echo off
REM ============================================================
REM  NEANDER - Simulacao do testbench do datapath
REM
REM  Uso:
REM    - duplo clique neste arquivo, ou
REM    - tb\datapath\datapath_tb.bat            (de qualquer pasta)
REM    - tb\datapath\datapath_tb.bat nopause    (sem a pausa no final)
REM
...
REM O datapath instancia os registradores, os muxes e a ULA.
set "NOME=datapath"
set "FONTES=src\datapath.v src\register8.v src\mux.v src\pc.v src\ula.v"
