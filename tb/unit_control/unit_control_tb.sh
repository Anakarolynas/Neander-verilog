#!/usr/bin/env bash
# ============================================================
#  NEANDER - Simulacao do testbench da unidade de controle
#
#  Uso:
#    ./tb/unit_control/unit_control_tb.sh        (de qualquer pasta do projeto)
#
#  Versao Linux/macOS do unit_control_tb.bat. Compila tb/unit_control/unit_control_tb.v
#  junto com os fontes do modulo e roda a simulacao.
#
#  Gera:
#    sim/sim_unit_control     executavel da simulacao
#    sim/unit_control.vcd     formas de onda, para abrir no GTKWave
# ============================================================
...
NOME="unit_control"
FONTES="src/unit_control.v src/fsm.v"
